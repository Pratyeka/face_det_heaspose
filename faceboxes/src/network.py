...
class FeatureExtractor:
    ...
    def __call__(self, images):
        ...
        with slim.arg_scope([slim.conv2d], **params):   # 添加上下文管理器空间内卷积函数的默认参数
            # 添加上下文管理器空间内最大池化层的默认参数
        ...
        with slim.arg_scope([slim.conv2d], **params):  # 添加上下文管理器空间内的卷积层默认参数

...
def transform_test(vertices, obj, camera, triangles, colors, h = 256, w = 256):
    '''
    Args:
...
if __name__ == '__main__':
    # --------- load mesh data
    C = sio.loadmat('./face3d/examples/Data/example1.mat')
    vertices = C['vertices'];
    global colors
    global triangles
    ...
    # save folder
    save_folder = './face3d/examples/results/transform'
